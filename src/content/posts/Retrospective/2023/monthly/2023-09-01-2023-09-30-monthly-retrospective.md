...
date: "2023-09-30"
tags: [회고, 플라잉닥터, 월간회고]
permalink: /Retrospective/2023-09-01-2023-09-30-monthly-retrospective.html
legacy_url: /Retrospective/2023/monthly/2023-09-01-2023-09-30-monthly-retrospective.html
---
## 개요

2023년 9월 한 달간의 회고록입니다. 이 달의 핵심 프로젝트는 **결제 프로세스 변경** 및 **병원 시간표 안정화**였습니다. 기존 페이플에서 결제선생으로 결제 시스템을 전환하고, 8월에 개발한 병원 시간표 개선을 안정화했습니다. 총 35개의 이슈를 처리하고, 27개의 커밋(서버 20개 + 프론트 6개 + 플러터 1개 + DB 스키마 2개)을 작성했습니다.
...
| 날짜 | 내용 |
|------|------|
| 09-07 | [20230907] Mobidoc Database Schema UPDATE |
| 09-26 | [RELEASE:20230926] UPDATE DDL |

### Flutter (1 commit) - 파일 공유 기능 수정

| 날짜 | 내용 |
|------|------|
| 09-11 | createFileFromBase64 - shareXFiles text, subject option 제거 |
...
이번 달 커밋 수(41개)는 이전 달(80개)에 비해 절반으로 줄었지만, 이는 새로운 기능 개발보다 **기존 기능의 안정화와 최적화**에 집중했기 때문입니다. 안정화 작업은 눈에 잘 띄지 않지만, 서비스 품질을 높이는 데 필수적인 작업입니다.

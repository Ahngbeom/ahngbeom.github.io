...
date: "2025-11-30"
tags: [회고, 모비닥, 월간회고]
permalink: /Retrospective/2025-11-01-2025-11-30-monthly-retrospective.html
legacy_url: /Retrospective/2025/monthly/2025-11-01-2025-11-30-monthly-retrospective.html
---
## 개요
...
| 항목 | 수량 |
|------|------|
| 총 커밋 수 | 63개 (백엔드 31개 + 프론트엔드 23개 + 플러터 5개 + helm 1개 + DB Migration 2개 + DB 스키마 1개) |
| 작업 레포지토리 | 3개 |
...
#### Flutter (mobidoc-flutter) - 5개 커밋

**주요 커밋 내역:**
- iOS 26 리퀴드 글래스 효과 대응 (11월 6일, 19일)
  - 앱 아이콘 리퀴드 글래스 효과 적용 방어 처리
  - 29개 파일 수정의 대규모 iOS 대응 작업 (2회)
- 버전 업데이트 (11월 6일, 19일)
  - v1.6.2 (+227 stag, +228 production)
  - v1.6.3 (+229 stag, +230 production)

#### mobidoc-helm(인프라) - 1개 커밋

front-doctor 서비스의 CPU/Memory 리소스를 증가시켰습니다.

- [values-my] front-doctor: cpu & memory 증가 (11월 21일)

#### mobidoc-migration(DB 마이그레이션) - 2개 커밋

- [MPT-8686] mobidoc product payment 테이블 (11-28 x2)

#### mobidoc-database(DB 스키마) - 1개 커밋

| 날짜 | 커밋 메시지 |
|------|------------|
| 11-28 | DDL Automation - Schema-Synchronization (Claude Agent) |

### 커밋 유형별 분류

| 유형 | 수량 | 비율 | 주요 내용 |
|------|------|------|-----------|
| feature | 4개 | 11.8% | 포인트 충전 결제 시스템, APM 모니터링 |
| fix | 15개 | 44.1% | 결제 동기화, 진료신청서 버그 수정, UX 개선, iOS 26 대응 |
| docs | 3개 | 8.8% | 아키텍쳐 문서, API 테스트 문서 |
| chore | 6개 | 17.6% | .gitignore 설정, Claude 플러그인, Merge, 버전 업데이트 |
| 기타 | 6개 | 17.6% | 설정 변경, 환경 구성 |
...
- 주 중 활동: 화요일-수요일에 집중
- Flutter 작업: 11월 6일(+3), 19일(+2)에 iOS 26 대응 및 버전 업데이트
...
- **월간 생산성 향상**: 62개 커밋(helm, DB Migration 포함)으로 33,206라인의 순증 코드 작성
  - 일평균 약 2.9개 커밋, 하루 평균 1,583라인 작성
  - 프론트엔드에서 특히 높은 생산성 (+18,431라인)
- **Flutter iOS 26 대응 완료**: 리퀴드 글래스 효과 방어 처리 및 v1.6.3 릴리즈
...
- **iOS 플랫폼 대응 경험**:
  - iOS 26 리퀴드 글래스 효과 등 새로운 OS 기능에 대한 방어적 처리 필요성 학습
  - 29개 파일에 걸친 대규모 UI 대응 작업을 2차례 수행하며 체계적 접근의 중요성 확인

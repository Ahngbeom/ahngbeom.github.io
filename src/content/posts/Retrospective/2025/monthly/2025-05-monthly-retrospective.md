...
date: "2025-05-31"
tags: [회고, 모비닥, 월간회고]
permalink: /Retrospective/2025-05-monthly-retrospective.html
legacy_url: /Retrospective/2025/monthly/2025-05-monthly-retrospective.html
---
## 개요

2025년 5월 월간 회고록입니다. 이번 달에는 총 13개의 이슈를 처리했으며, 외부 API 연동, 본인인증 프로세스 개선, SEO 최적화 등 다양한 신규 기능 개발과 개선 작업을 진행했습니다. Helm Chart를 통한 위뉴 연동 환경 변수 설정도 수행했습니다. 특히 **YouTube API 연동**, **위뉴(weknew) 컨텐츠 서비스 연동**, **병원 홈페이지 SEO 메타데이터 관리** 등 플랫폼 확장성을 높이는 작업에 집중했습니다.
...
| 항목 | 수량 |
|------|------|
| 총 커밋 수 | 55개 (백엔드 27개 + 프론트엔드 14개 + helm 2개 + DB Migration 11개 + DB 스키마 1개) |
| 작업 레포지토리 | 2개 |
...
위뉴 컨텐츠 서비스 연동을 위한 Helm Chart 환경 변수 설정 작업을 수행했습니다.

- [api-patient] weknew.corp-id 환경 변수 추가 (5월 28일)
- weknew.corp-id 환경 변수 제거 (5월 29일) — 설정 롤백

#### mobidoc-migration(DB 마이그레이션) - 11개 커밋

**주요 작업:**
- 환자 커플링 업데이트, release-20250429 (05-02, 05-08)
- room_display_order 컬럼 변경 (05-13)
- [MPT-8027] mobidoc_tester 테이블, [NT2-918] Hospital Homepage SEO (05-15 x2)
- Utils/Add Mobidoc Tester (05-16)
- WEATHER_BATCH_TASK_EXECUTION (05-19)
- CREATE TABLE weknew contents (05-20, 05-23 x2)
- [MPT-8095] weknew contents & hospital youtubes (05-29)

#### mobidoc-database(DB 스키마) - 1개 커밋

| 날짜 | 커밋 메시지 |
|------|------------|
| 05-08 | Unused DROP TABLE & COLUMN |
...
- **월간 생산성**: 54개 커밋(helm, DB Migration 포함)으로 7,304라인의 순증 코드 작성

...
2023년 10월 한 달간의 회고록입니다. 이 달의 핵심 프로젝트는 **결제선생 전면 도입** 및 **알림 시스템 개선**이었습니다. 기존 페이플에서 결제선생으로의 완전 전환을 완료하고, 방문예약/피드 관련 알림 시스템을 강화했습니다. 총 21개의 이슈를 처리하고, 41개의 커밋(서버 30개 + 프론트 11개)을 작성했습니다.

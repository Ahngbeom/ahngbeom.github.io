...
2024년 2월 한 달간의 회고록입니다. 이 달의 핵심 프로젝트는 **진료 중복 접수 방어** 및 **태블릿 접수 개선**이었습니다. 진료 예약과 바로접수 시 중복 접수를 방지하는 로직을 강화하고, 태블릿 접수 시스템의 사용성을 지속적으로 개선했습니다. 또한 EMR 연동을 위한 테이블을 구축하고, 병원 시간표 오류를 수정했습니다. 총 33개의 이슈를 처리하고, 7개의 커밋(서버 7개 + 프론트 0개)을 작성했습니다.

...
2023년 7월 한 달간의 회고록입니다. 이 달의 핵심 프로젝트는 **바로접수 기능 개발 및 안정화**였습니다. 6월에 완료된 진료 통합 기반 위에 새로운 바로접수 기능을 개발하고, 관련 UX를 대폭 개선했습니다. 총 50개의 이슈를 처리하고, 40개의 커밋(서버 40개 + 프론트 0개)을 작성했습니다.

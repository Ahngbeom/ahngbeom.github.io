...
2024년 4월 한 달간의 회고록입니다. 이 달의 핵심 프로젝트는 **진료 테이블 v2 마이그레이션** 및 **함께 진료(가족 진료) 안정화**였습니다. 진료 관련 테이블을 v2로 전면 전환하고, 함께 진료 시 발생하는 다양한 버그를 수정했습니다. 또한 태블릿 접수의 주소 입력 UX를 대폭 개선하고, 주민등록번호 유효성 검사 로직을 강화했습니다. 총 80개 이상의 이슈를 처리하고, 26개의 커밋(서버 26개 + 프론트 0개)을 작성했습니다.

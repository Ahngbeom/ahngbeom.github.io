...
2023년 8월 한 달간의 회고록입니다. 이 달의 핵심 프로젝트는 **진료신청서 개선** 및 **병원 시간표 개선**이었습니다. WEB/APP 진료신청서에 C.C(Chief Complaint, 주 호소 증상) 기능을 추가하고, 병원 시간표를 의사 스케줄 기반으로 재설계했습니다. 총 38개의 이슈를 처리하고, 101개의 커밋(서버 56개 + 프론트 45개)을 작성했습니다.
...
총 101개의 커밋은 지금까지 가장 많은 수치로, 진료신청서와 병원 시간표라는 복잡한 기능 개선에 많은 코드 변경이 필요했음을 보여줍니다.

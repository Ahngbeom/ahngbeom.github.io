...
2025년 3월에는 **30개의 Jira 이슈**와 **18개의 커밋**(BE 17개 + FE 1개)을 처리하며 **가예약 시스템 고도화** 및 **통계 데이터 인프라 구축**에 집중했습니다. 가예약 QR 접수 기능을 신규 개발하고, 병원 통계 테이블을 생성하여 데이터 기반 의사결정 기반을 마련했습니다.
...
2. **커밋 수 감소**:
   - 18개 커밋으로 2월(35개) 대비 48.6% 감소
   - 이슈 수는 증가했으나 커밋 수는 감소
